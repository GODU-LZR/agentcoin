...
- signed read-only preview plus replay or settlement inspection, workflow-admin, bridge-admin, Tier 3, and Tier 4 operator request verification, nonce replay rejection, denial auth-receipt persistence, and workflow / bridge governance receipt persistence
