    ...
    def card(self) -> AgentCard:
        ...
        return AgentCard(
            ...
            endpoints={
                ...
                "local_agent_start": f"{self.base_url}/v1/discovery/local-agents/start",
                "local_agent_stop": f"{self.base_url}/v1/discovery/local-agents/stop",
                ...
                "claude_http_follow_up_from_tool_task": f"{self.base_url}/v1/integrations/claude-http/follow-up-from-tool-task",
